...
#ifndef EXTREME_PRIVATE_MASTERNODE_QT_PROPOSALFRAME_H
#define EXTREME_PRIVATE_MASTERNODE_QT_PROPOSALFRAME_H
...
#endif //EXTREME_PRIVATE_MASTERNODE_QT_PROPOSALFRAME_H
