...
// Wallet
    ...
    if (settings.contains("nAnonymizeExtreme_Private_MasternodeAmount"))
        SoftSetArg("-anonymizeextreme_private_masternodeamount", settings.value("nAnonymizeExtreme_Private_MasternodeAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in extreme_private_masternode.cpp during shotdown to also remove the window positions
