...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Extreme Private Masternode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and extreme_private_masternode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEPM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Extreme Private Masternode Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Extreme Private Masternode Coin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for EXTREME_PRIVATE_MASTERNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Extreme Private Masternode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Extreme Private Masternode addresses"));
    ...
    openAction->setStatusTip(tr("Open a EXTREME_PRIVATE_MASTERNODE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Extreme Private Masternode Coin help message to get a list with possible Extreme Private Masternode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Extreme Private Masternode Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Extreme Private Masternode network", "", count));
}
...
{
    QString strTitle = tr("Extreme Private Masternode Coin"); // default title
    ...
    // Append title to "EXTREME_PRIVATE_MASTERNODE - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
