...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Extreme Private Masternode Coin"),
     ...
     * override -datadir in the extreme_private_masternode.conf file in the default data directory
     * (to be consistent with extreme_private_masternoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
