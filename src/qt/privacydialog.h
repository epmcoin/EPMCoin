...
public:
    ...
    void setZEpmControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzEPM_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEPM_clicked();
    void on_pushButtonZEpmControl_clicked();
