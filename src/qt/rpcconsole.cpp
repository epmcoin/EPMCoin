                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEPMPathCustom = GetArg("-zepmbackuppath", "");
    ...
    if(!strzEPMPathCustom.empty()) {
        ui->wallet_customzepmbackuppath->setText(QString::fromStdString(strzEPMPathCustom));
        ui->wallet_customzepmbackuppath_label->setVisible(true);
        ui->wallet_customzepmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEPMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Extreme Private Masternode RPC console.") + "<br>" +
