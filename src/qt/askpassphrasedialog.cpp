                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zEPM || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending EPM because you wouldn't check it anyway.
    if (context == Context::Send_EPM || context == Context::Send_zEPM) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("EXTREME_PRIVATE_MASTERNODE will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your EPMs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
