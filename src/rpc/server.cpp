...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Extreme Private Masternode server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "EXTREME_PRIVATE_MASTERNODE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Extreme Private Masternode features */
        {"extreme_private_masternode", "listmasternodes", &listmasternodes, true, true, false},
        {"extreme_private_masternode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"extreme_private_masternode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"extreme_private_masternode", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"extreme_private_masternode", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"extreme_private_masternode", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"extreme_private_masternode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"extreme_private_masternode", "masternodedebug", &masternodedebug, true, true, false},
        {"extreme_private_masternode", "startmasternode", &startmasternode, true, true, false},
        {"extreme_private_masternode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"extreme_private_masternode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"extreme_private_masternode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"extreme_private_masternode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"extreme_private_masternode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"extreme_private_masternode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"extreme_private_masternode", "preparebudget", &preparebudget, true, true, false},
        {"extreme_private_masternode", "submitbudget", &submitbudget, true, true, false},
        {"extreme_private_masternode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"extreme_private_masternode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"extreme_private_masternode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"extreme_private_masternode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"extreme_private_masternode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"extreme_private_masternode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"extreme_private_masternode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"extreme_private_masternode", "checkbudgets", &checkbudgets, true, true, false},
        {"extreme_private_masternode", "mnsync", &mnsync, true, true, false},
        {"extreme_private_masternode", "spork", &spork, true, true, false},
        {"extreme_private_masternode", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzepmseed", &getzepmseed, false, false, true},
        {"zerocoin", "setzepmseed", &setzepmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzepm", &searchdzepm, false, false, true},
        {"zerocoin", "dzepmstate", &dzepmstate, false, false, true},
...
{
    return "> extreme_private_masternode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2679/\n";
}
