...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Extreme Private Masternode Coin extreme_private_masternode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  extreme_private_masternode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded extreme_private_masternode transaction") + "\n" +
                               "  extreme_private_masternode-tx [options] -create [commands]   " + _("Create hex-encoded extreme_private_masternode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded extreme_private_masternode transaction
