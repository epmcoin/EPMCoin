...
#ifndef EXTREME_PRIVATE_MASTERNODE_ZEPMTRACKER_H
#define EXTREME_PRIVATE_MASTERNODE_ZEPMTRACKER_H
...
public:
    CzEPMTracker(std::string strWalletFile);
    ~CzEPMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzEPMWallet* zEPMWallet = NULL);
...
#endif //EXTREME_PRIVATE_MASTERNODE_ZEPMTRACKER_H
