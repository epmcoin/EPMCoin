...
#ifndef EXTREME_PRIVATE_MASTERNODE_DETERMINISTICMINT_H
#define EXTREME_PRIVATE_MASTERNODE_DETERMINISTICMINT_H
...
#endif //EXTREME_PRIVATE_MASTERNODE_DETERMINISTICMINT_H
