...
/** 
    ...
    ****Note - for Extreme Private Masternode we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of extreme_private_masternode coming in to a transaction
