...
#include "key.h"
#include "zepm/accumulatorcheckpoints.h"
...
#include "zepmchain.h"
#include "test_extreme_private_masternode.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzEPMWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZEPM(denom, coin, dMint);
