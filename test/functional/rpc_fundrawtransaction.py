...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid extreme_private_masternode address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid extreme_private_masternode address" in e.error['message'])
