...
from fake_stake.base_test import EXTREME_PRIVATE_MASTERNODE_FakeStakeTest

class zEPMwrappedSerialsTest(EXTREME_PRIVATE_MASTERNODE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zEPMs..." % DENOM_TO_USE)
