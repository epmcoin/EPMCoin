Contributing to Extreme Private Masternode Coin
============================

The Extreme Private Masternode Coin project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to extreme_private_masternode-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the extreme_private_masternode unit tests or QA tests
...
[Translation Process](https://github.com/extreme_private_masternode-project/extreme_private_masternode/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Extreme Private Masternode Coin project, and is not to be
confused with overall Extreme Private Masternode Network Protocol consensus changes.

Whether a pull request is merged into Extreme Private Masternode Coin rests with the project merge
...
Patches that change Extreme Private Masternode consensus rules are considerably more involved than
...
Where a patchset proposes to change the Extreme Private Masternode consensus, it must have been
...
The project leader is the release manager for each Extreme Private Masternode Coin release.
