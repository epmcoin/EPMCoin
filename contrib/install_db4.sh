...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the extreme_private_masternode repository."
  exit 1
fi
...
echo
echo 'When compiling extreme_private_masternoded, run `./configure` in the following way:'
echo
